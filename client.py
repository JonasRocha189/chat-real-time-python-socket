...
class Chat:
  def __init__(self):
    ...
    self.room = simpledialog.askstring('Room', 'Type the room that you want to get in: ', parent=login)
  ...
  def window(self):
    ...
    self.btn_send = Button(self.root, text="Send Message", command = self.sendMessage)
